...
abstract class SimulationController : MonoBehaviour
{
	...
	private void InitBaseTraits()
	{
		...
		AnimalTraits rabbitTraits = new AnimalTraits(Species.Rabbit, maxSize, 0, 2.1, 4, 5, 30, smellRadius, new RabbitFCMHandler(FCMFactory.RabbitFCM()), plantArr, foxArr, rabbitArr);
		AnimalTraits foxTraits = new AnimalTraits(Species.Fox, maxSize, 1, 2, 4, 5, 30, smellRadius, new FoxFCMHandler(FCMFactory.FoxFCM()), rabbitArr, emptyArr, foxArr);
